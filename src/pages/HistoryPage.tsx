...
const HistoryPage: React.FC = () => {
    ...
    // minute-tick currentTime change so the date-stamp / red-flag toggle on
    // each history row reacts to new doses, plan edits, and the day-rollover
    // window. We only need the `mismatches` list here.
