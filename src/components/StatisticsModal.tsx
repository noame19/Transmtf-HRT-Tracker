      ...
      <div className="rounded-3xl w-full max-w-lg p-6 md:p-8 modal-spring-glass glass-modal">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>{t('statistics.loading')}</p>
          </div>
        )}
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-4 p-4 bg-[var(--bg-soft-purple)] rounded-2xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>{stats.total_users.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-[var(--bg-soft-green)] rounded-2xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>{stats.data_syncs_last_7days.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-[var(--bg-soft-blue)] rounded-2xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>{formatDatabaseSize(stats.database_size_mb)}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-[var(--bg-soft-amber)] rounded-2xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-bold" style={{ color: 'var(--text-primary)' }}>{formatDate(stats.last_updated_at)}</p>
              </div>
            </div>
          </div>
        )}
