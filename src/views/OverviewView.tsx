...
const OverviewView: React.FC<OverviewViewProps> = ({
  ...
  return (
    <>
      <header className="relative overflow-x-hidden px-2 md:max-lg:px-2 lg:px-8 safe-area-pt md:pt-6 pb-3 md:pb-4">
      ...
      <main className="w-full overflow-x-hidden px-2 md:max-lg:px-2 lg:px-8 pt-0 pb-4 md:pb-6 rounded-t-3xl"
